...
export default function Product() {
  ...
  const handleEditQuantity = async () =>{
    ...
    if (color != '' && size != ''){
          await axios
              .get(`http://localhost:8080/api/products/get_quanity?id=${id}&&color=${color}&&size=${size}`)
              .then((result) => {
    ...
    <div className="product">
      <div className="productTitleContainer">
        <h1 className="productTitle">Product</h1>
          <button onClick={handleRestok} className="productAddButton">{isRestock ? "Edit General" : "Restock"}</button>
      </div>
      ...
      <Box sx={{ padding: 5 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={2} sx={{
            ...
            <Button onClick={handleRestock} fullWidth variant="contained" sx={{ 
              color: "#fff",
              }}>
              Apply
            </Button>
      ...
      <Box sx={{ padding: 5 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={2} sx={{
            ...
            <Button onClick={handleEdit} fullWidth variant="contained" sx={{ 
              color: "#fff",
              }}>
              Edit
            </Button>
