...
export const  Homepage = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <Box sx={{ width: '80%' }}>
          <Typography gutterBottom variant="h6" component="div" sx={{ fontSize: 40, fontWeight: 700, }}>
            Best Sellers
          </Typography>
          <Stack 
            direction='row' 
      ...
      <Box 
        ...
        alignItems="center"
      >
        <Box direction='row' display="flex" justifyContent="space-between" alignItems="center" sx={{ width: '80%', mt: 10 }}>
